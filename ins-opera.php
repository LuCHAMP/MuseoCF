...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $listsql = "INSERT INTO opere (CodOpera, Nome, Tipo) VALUES
                ('$cod', '$nome', '$tipo')";

    if (mysqli_query($conn, $listsql)) {
        echo "<h3 style='color:#ffbf00; text-align:center;'>Opera aggiunta con successo</h3>";
    } else {
        echo "<h3 style='color:red; text-align:center;'>Errore nell'aggiunta dell'opera: " . mysqli_error($conn) . "</h3>";
    }
}    
?>