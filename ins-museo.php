...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $listsql = "INSERT INTO musei (CodMuseo, Nome) VALUES
                ('$cod', '$nome')";

    if (mysqli_query($conn, $listsql)) {
        echo "<h3 style='color:#ffbf00; text-align:center;'>Museo aggiunto con successo</h3>";
    } else {
        echo "<h3 style='color:red; text-align:center;'>Errore nell'aggiunta del museo: " . mysqli_error($conn) . "</h3>";
    }
}    
?>