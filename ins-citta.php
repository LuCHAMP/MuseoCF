...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $listsql = "INSERT INTO citta (CodCitta, Nome) VALUES
                ('$cod', '$nome')";

    if (mysqli_query($conn, $listsql)) {
        echo "<h3 style='color:#ffbf00; text-align:center;'>Città aggiunta con successo</h3>";
    } else {
        echo "<h3 style='color:red; text-align:center;'>Errore nell'aggiunta della città: " . mysqli_error($conn) . "</h3>";
    }
}
?>